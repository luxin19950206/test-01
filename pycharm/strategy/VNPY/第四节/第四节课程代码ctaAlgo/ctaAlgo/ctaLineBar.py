...
class CtaLineBar(object):
    ...
    lineMSetting['inputMacdFastPeriodLen']=26
    lineMSetting['inputMacdSlowPeriodLen']=52
    lineMSetting['inputMacdSignalPeriodLen']=22
    ...
    创建M3 K线
    lineM3Setting={}
    lineM3Setting['name'] = u'M3'
    lineM3Setting['barTimeInterval'] = 60*3
    lineM3Setting['inputBollLen'] = 20
    lineMSetting['inputBollStdRate'] = 2    # 布林特线标准差
    lineM3Setting['minDiff'] = self.minDiff  # 最小条
    lineM3Setting['shortSymbol'] = self.shortSymbol  #商品短号
    self.lineM3 = CtaLineBar(self, self.onBarM3, lineM3Setting)
