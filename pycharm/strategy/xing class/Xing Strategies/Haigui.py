...
# rolling：取一段时间的数据综合，expanding：取
...
index_data.loc[buy_index, '收盘发出的信号'] = 1  # 创建一个新的DataFrame列
...
'''
index_data的columns中有date, high, low, close, change, 最近N1个交易日的最高点，最近N1个交易日的最低点
收盘发出的信号，当天的仓位，资金指数
'''
